...
export function Usecases() {
    ...
    const handleCaseClick = (event: MouseEvent<HTMLButtonElement>) => {
        const nextCase = event.currentTarget.dataset
            .case as keyof typeof useCases;
        ...
        <section className="section section-shell usecases" id="usecases">
            <div className="usecases__heading">
                ...
                <p className="section-intro">
                    Снэпбилд помогает командам двигаться быстрее без потери
                    качества и контроля над стилем.
                </p>
            </div>
            ...
            <div className="usecases__content">
                ...
                >
                    ...
                    <div className="usecases__visual-title">
                        {currentCase.title}
                    </div>
